...
x_values = []
y_values = []
with open("dur_bw_overprov.dat", 'r') as f:
    data = f.readlines()
...
PDF = PdfPages("dur_bw_overprov.pdf")

x_labels = ['TeraSort','ML Prep','PageRank', 'Alibaba']
...
#plt.savefig("dur_bw_overprov.png")
#plt.savefig("dur_bw_overprov.pdf")
